...
const Sidebar = () => {
  ...
  const sidebarMenu = (
    <nav className={` duration-300 px-2`}>
      {/* <!-- Menu Group --> */}
  ...
  return (
    <>
      ...
      >
        ...
        <div className="flex w-[95%] mx-auto p-2 flex-col items-center content-center mt-5 gap-y-1  border-b-2 border-gray-300 dark:border-darkborder">
          {/* <!-- ===== User Profile Image Start ===== --> */}
          <div
        ...
        <div
          ...
          }  border-t-[2px]   border-gray-300  dark:border-darkborder ${
            !sidebarOpen && "flex-col"
          }`}
        >
          <IconButton variant="text" className="m-auto">
